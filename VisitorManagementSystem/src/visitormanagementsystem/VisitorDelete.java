 ...
 * @author justi
 */
public class VisitorDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(visitorDetailsText, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 270, 30));
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        try{
            ...
            PreparedStatement pst = con.prepareStatement("DELETE FROM visitor WHERE VisitorID = ?");
    ...
    private void minimizeLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeLogoMouseClicked
        this.setExtendedState(VisitorDelete.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisitorDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisitorDelete().setVisible(true);
            }
        });
    }
