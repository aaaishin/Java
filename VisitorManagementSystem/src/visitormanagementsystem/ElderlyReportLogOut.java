 ...
 * @author justi
 */
public class ElderlyReportLogOut extends javax.swing.JFrame {
    ...
    private void minimizeLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeLogoMouseClicked
        this.setExtendedState(ElderlyReportLogOut.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElderlyReportLogOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElderlyReportLogOut().setVisible(true);
            }
        });
    }
