 ...
 * @author justi
 */
public class VisitorInformationLogOut extends javax.swing.JFrame {
    ...
    public VisitorInformationLogOut() {
        initComponents();
    ...
    private void minimizeLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeLogoMouseClicked
        this.setExtendedState(VisitorInformationLogOut.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisitorInformationLogOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisitorInformationLogOut().setVisible(true);
            }
        });
    }
