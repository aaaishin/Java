 ...
 * @author justi
 */
public class DateOfVisitDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dateofvisitTable.setBackground(new java.awt.Color(231, 228, 228));
        dateofvisitTable.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(129, 159, 29), 1, true));
        dateofvisitTable.setForeground(new java.awt.Color(107, 132, 22));
        dateofvisitTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "VisitorID", "ElderlyID", "VisitDate", "VisitTime"
            }
        ) {
        ...
        dateofvisitTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        dateofvisitTable.setGridColor(new java.awt.Color(129, 159, 29));
        dateofvisitTable.setName("dateofvisitTable"); // NOI18N
        dateofvisitTable.setSelectionBackground(new java.awt.Color(183, 216, 72));
        dateofvisitTable.setSelectionForeground(new java.awt.Color(255, 255, 255));
        dateofvisitTable.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        dateofvisitTable.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        dateofvisitTable.setShowGrid(true);
        visitorScroll.setViewportView(dateofvisitTable);
    ...
    private void adminLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adminLogoMouseClicked
        DateOfVisitDetailsLogOut logout = new DateOfVisitDetailsLogOut();
    ...
    public void search(String str){
        DefaultTableModel table = (DefaultTableModel) dateofvisitTable.getModel();
        TableRowSorter<DefaultTableModel> trs = new TableRowSorter<>(table);
        dateofvisitTable.setRowSorter(trs);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DateOfVisitDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DateOfVisitDetails().setVisible(true);
            }
        });
    }
