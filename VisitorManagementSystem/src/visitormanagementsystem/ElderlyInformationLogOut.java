 ...
 * @author justi
 */
public class ElderlyInformationLogOut extends javax.swing.JFrame {
    ...
    public ElderlyInformationLogOut() {
        initComponents();
    ...
    private void minimizeLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeLogoMouseClicked
        this.setExtendedState(ElderlyInformationLogOut.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElderlyInformationLogOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElderlyInformationLogOut().setVisible(true);
            }
        });
    }
