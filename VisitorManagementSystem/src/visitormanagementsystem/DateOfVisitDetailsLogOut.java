 ...
 * @author justi
 */
public class DateOfVisitDetailsLogOut extends javax.swing.JFrame {
    ...
    public DateOfVisitDetailsLogOut() {
        initComponents();
    ...
    private void minimizeLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeLogoMouseClicked
        this.setExtendedState(DateOfVisitDetailsLogOut.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DateOfVisitDetailsLogOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DateOfVisitDetailsLogOut().setVisible(true);
            }
        });
    }
